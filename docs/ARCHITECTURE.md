...
flowchart TD
    ...
    Service -- "Browser / PWA mode" --> Mock[Simulated API and Delays]
    Service -- "Portable USB mode" --> Port[Served via Python/PS1 HTTP]
    Service -- "Tauri present" --> Tauri[Tauri IPC Bridge]
