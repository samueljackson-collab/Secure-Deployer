    ...
    return (
        <div className="bg-gray-950 p-4 rounded-lg shadow-lg border border-gray-800">
                ...
                {(state.runner.templates || []).map(template => (
                    <div key={template.id} className="bg-black/50 p-3 rounded-md border border-gray-700 flex justify-between items-center">
                        ...
                        <div className="flex gap-2">
                            <button onClick={() => dispatch({ type: 'APPLY_TEMPLATE', payload: template })} className="px-3 py-1 bg-blue-600 text-white text-xs font-semibold rounded-lg hover:bg-blue-500 transition-colors">Load</button>
            ...
            <div className="mt-4 pt-4 border-t border-gray-800">
                <h4 className="text-md font-semibold text-gray-300 mb-2">Save Current Settings as Template</h4>
