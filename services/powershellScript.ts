...
const RISKY_PATTERNS: Array<{ regex: RegExp; pattern: string; description: string; severity: 'medium' | 'high' }> = [
    ...
    { regex: /\bSet-ExecutionPolicy\b.*Unrestricted\b/i, pattern: 'Set-ExecutionPolicy Unrestricted', description: 'Removes all script execution restrictions.', severity: 'medium' },
